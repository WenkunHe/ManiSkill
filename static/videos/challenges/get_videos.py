...
while True:
    ...
    bins[0].append(frame[1024:1536, 512:1024, :])
    frame_count += 1
...
while True:
    ...
    bins[1].append(frame[1536:2048, 1024:1536, :])
    frame_count += 1
    print(f"正在处理第 {frame_count} 帧")
...
output_width = frame_width * 2   # 拼接后宽度为 4 倍单帧宽度

# 初始化视频写入器
output_path = "output_video_2x4.mp4"
fps = 30  # 设置帧率
